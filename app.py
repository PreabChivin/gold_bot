...
def get_prices(retries=3, delay=2):
    for attempt in range(retries):
        try:
            ...
            gold_res = requests.get("https://gold-api.com/price/XAU", headers=headers, timeout=10)
            silver_res = requests.get("https://gold-api.com/price/XAG", headers=headers, timeout=10)
